...
def find_and_replace(filename, pkg_name, email, description=None, maintainer=None):
    ...
    camelcase_pkg_name = "".join([word.capitalize() for word in pkg_name.split("_")])
...
def main():
    ...
    parser.add_argument(
        ...
        required=False,
        default=".",
        help="Path to new package (without package name)." "e.g., ~/autoware_ws/src",
    )
    parser.add_argument("--pkg-name", required=True, help="Name of the new package")
    parser.add_argument("--maintainer", required=True, help="Name of maintainer (for package.xml)")
    parser.add_argument("--email", required=True, help="Email of the maintainer (for package.xml)")
    parser.add_argument(
        "--description", required=True, help="Description of package (for package.xml)"
    )
    ...
    template_pkg_dir = os.path.join(
        get_package_share_directory("autoware_core_create_pkg"), "template"
    )
